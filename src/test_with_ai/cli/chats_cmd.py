...
def chats_group() -> None:
    ...
    \b
    Common examples:
      test_with_ai chats list                    # List all chats
      test_with_ai chats list --user-id alice    # Filter by user
      test_with_ai chats get <chat_id>           # View details
      test_with_ai chats create --session-id s1 --user-id u1
      test_with_ai chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    \b
    Examples:
      test_with_ai chats list
      test_with_ai chats list --user-id alice
      test_with_ai chats list --channel discord
      test_with_ai chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `test_with_ai chats list`.

    \b
    Examples:
      test_with_ai chats get 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
...
def create_chat(
    ...
    Inline creation examples:
      test_with_ai chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      test_with_ai chats create -f chat.json
    """
    base_url = _base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      test_with_ai chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
...
def delete_chat(
    ...
    \b
    Examples:
      test_with_ai chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
