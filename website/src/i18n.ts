...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "hero.slogan": "懂你所需，伴你左-,
    "hero.sub":
      "你的AI个人助理；安装极简、本地与云上均可部署；支持多端接入、能力轻松扩展-,
    "hero.cta": "查看文档",
    "follow.title": "关注我们",
    "follow.sub": "第一时间获取 Test with AI 最新动-,
    "follow.xiaohongshu": "小红书：",
    "follow.x": "X-,
    "brandstory.title": "Why Test with AI-,
    "brandstory.para1":
      "Test with AI 既是「你的搭档小爪子」（co-paw），也寓-Co Personal Agent Workstation（协同个人智能体工作台）-,
    "brandstory.para2":
      "我们希望它不是冰冷的工具，而是一只随时准备帮忙的温暖「小爪子」，是你数字生活中最默契的伙伴-,
    "features.title": "核心能力",
    "features.channels.title": "全域触达",
    "features.channels.desc":
      "支持钉钉、飞书、QQ、Discord、iMessage 等频道，一-Test with AI 按需连接-,
    "features.private.title": "由你掌控",
    "features.private.desc":
      "记忆与个性化由你掌控，本地或云端均可；定时与协作发往指定频道-,
    "features.skills.title": "Skills 扩展",
    "features.skills.desc": "内置定时任务，自定义技能目录，Test with AI 自动加载-,
    "testimonials.title": "社区怎么-,
    "testimonials.viewAll": "查看全部",
    "testimonials.1": "Test with AI 就该这样：多频道一个入口，Python 好改好部署-,
    "testimonials.2": "定时和心跳很实用，Skills 自己加，数据都在本地-,
    "testimonials.3": "想完全掌控的团队用着很顺手-,
    "usecases.title": "你可以用 Test with AI 做什-,
    "usecases.sub": "",
    "usecases.category.social": "社交媒体",
    "usecases.category.creative": "创意与构-,
    "usecases.category.productivity": "生产-,
    "usecases.category.research": "研究与学-,
    "usecases.category.assistant": "桌面与文-,
    ...
    "usecases.creative.1":
      "睡前-Test with AI 说明目标并设定自动执行，次日即可获得可用的雏形-,
    "usecases.creative.2":
      "从选题、找素材到确定方向，Test with AI 可协助完成视频内容创作全流程-,
    ...
    "usecases.productivity.3":
      "记录饮食与身体反应，-Test with AI 定期分析并呈现规律-,
    "usecases.research.1":
      "自动追踪科技-AI 公司财报与重要资讯，筛选重点并生成摘要-,
    "usecases.research.2":
      "将链接、文章与帖子存入个人知识库，便于在多场景中检索与复用-,
    "usecases.assistant.1":
      "协助整理与搜索本地文件、阅读文档并做摘要；在钉钉、飞书或 QQ 中通过对话将指定文件发至当前会话-,
    "usecases.explore.1":
      "你可以探索更多可能，-Skills 与定时任务组合成 agentic app-,
    "quickstart.title": "快速开-,
    "quickstart.hintBefore": "安装 -初始-启动；频道配置见 ",
    "quickstart.hintLink": "文档",
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使-Test with AI-,
    ...
    "quickstart.optionDocker": "Docker 镜像（Docker Hub，国内可-ACR-,
    "quickstart.tabAliyun": "阿里-ECS",
    "quickstart.tabAliyunMain": "阿里-ECS",
    "quickstart.tabAliyunSub": "",
    "quickstart.tabPipShort": "pip",
    "quickstart.tabUnixShort": "Mac/Linux",
    "quickstart.tabWindowsShort": "Windows",
    "quickstart.tabAliyunShort": "阿里-,
    "quickstart.optionAliyun": "阿里-ECS 一键部-,
    "quickstart.aliyunDeployLink": "部署链接",
    "quickstart.aliyunDocLink": "说明文档",
    footer: "Test with AI -懂你所需，伴你左-,
    "footer.poweredBy.p1": "-",
    "footer.poweredBy.p2": " 基于 ",
    "footer.poweredBy.p3": "-,
    "footer.poweredBy.p3b": " -",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest Test with AI updates",
    "follow.xiaohongshu": "Rednote:",
    "follow.x": "X:",
    "brandstory.title": "Why Test with AI?",
    "brandstory.para1":
      'Test with AI represents both a Co Personal Agent Workstation and a "co-paw"—a partner always by your side.',
    "brandstory.para2":
      'More than just a cold tool, Test with AI is a warm "little paw" always ready to lend a hand (or a paw!). It is the ultimate teammate for your digital life.',
    ...
    "usecases.title": "What you can do with Test with AI",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to Test with AI and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, Test with AI supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; Test with AI analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install -init -start. Configure channels to use Test with AI on DingTalk, Feishu, QQ, etc. See ",
    ...
    footer: "Test with AI -Works for you, grows with you",
