...
const DOCKER_IMAGE = "agentscope/test_with_ai:latest";

const COMMANDS = {
  pip: ["pip install test_with_ai", "test_with_ai init --defaults", "test_with_ai app"],
  unix: [
    "curl -fsSL https://test_with_ai.agentscope.io/install.sh | bash",
    "test_with_ai init --defaults",
    "test_with_ai app",
  ],
  windows: [
    "irm https://test_with_ai.agentscope.io/install.ps1 | iex",
    "test_with_ai init --defaults",
    "test_with_ai app",
  ],
  docker: [
    `docker pull ${DOCKER_IMAGE}`,
    `docker run -p 127.0.0.1:8088:8088 -v test_with_ai-data:/app/working ${DOCKER_IMAGE}`,
  ],
} as const;
