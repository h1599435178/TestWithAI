    ...
    >
      ...
      >
        ...
        >
          ...
          <a
            href="https://github.com/agentscope-ai/Test with AI"
            target="_blank"
            rel="noopener noreferrer"
            className={linkClass}
            title="Test with AI on GitHub"
          >
          ...
          <a
            ...
            className={linkClass}
            title={
              lang === "zh" ? "基于 AgentScope 打- : "Built on AgentScope"
            }
      ...
      >
        ...
        <a
          ...
          className={linkClass}
          onClick={() => setOpen(false)}
          title={lang === "zh" ? "基于 AgentScope 打- : "Built on AgentScope"}
          aria-label={t(lang, "nav.agentscopeTeam")}
          style={{
            display: "inline-flex",
            alignItems: "center",
