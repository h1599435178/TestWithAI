...
// Doc URLs per channel (anchors on https://test_with_ai.agentscope.io/docs/channels)
const CHANNEL_DOC_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://test_with_ai.agentscope.io/docs/channels/#%E9%92%89%E9%92%89%E6%8E%A8%E8%8D%90",
  feishu: "https://test_with_ai.agentscope.io/docs/channels/#%E9%A3%9E%E4%B9%A6",
  imessage:
    "https://test_with_ai.agentscope.io/docs/channels/#iMessage%E4%BB%85-macOS",
  discord: "https://test_with_ai.agentscope.io/docs/channels/#Discord",
  qq: "https://test_with_ai.agentscope.io/docs/channels/#QQ",
  telegram: "https://test_with_ai.agentscope.io/docs/channels/#Telegram",
};
        ...
        return (
          <>
            ...
            <Form.Item name="media_dir" label="Media Dir">
              <Input placeholder="~/.test_with_ai/media" />
            </Form.Item>
          </>
        );
      case "qq":
