...
from test_with_ai.agents.hooks.memory_compaction import MemoryCompactionHook
...
async def test_compaction_triggers_on_total_context_budget(
    ...
    monkeypatch.setattr(
        "test_with_ai.agents.hooks.memory_compaction.safe_count_message_tokens",
        _fake_safe_count_message_tokens,
    )
    monkeypatch.setattr(
        "test_with_ai.agents.hooks.memory_compaction.safe_count_str_tokens",
        _fake_safe_count_str_tokens,
    )
    monkeypatch.setattr(
        "test_with_ai.agents.hooks.memory_compaction.load_config",
    ...
    monkeypatch.setattr(
        "test_with_ai.agents.hooks.memory_compaction.MEMORY_COMPACT_KEEP_RECENT",
        1,
    )
